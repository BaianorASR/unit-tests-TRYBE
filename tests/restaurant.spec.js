const { createMenu, order, restaurant } = require('../src/restaurant');
...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    const obj = { food: {}, drink: {} };
      ...
      // ```
      expect(Object.keys(createMenu(obj).fetchMenu())).toContain('food');
      expect(Object.keys(createMenu(obj).fetchMenu())).toContain('drink');
      ...
      // ```
      expect(createMenu(obj).consumption).toHaveLength(0);
      ...
      // ```
      expect(restaurant.order('coxinha')).toBeUndefined();
      expect(restaurant.consumption).toContain('coxinha');
      // Agora faça o PASSO 3 no arquivo `src/restaurant.js`.
      restaurant.consumption.pop();
    ...
    // --------------------------------------------------------------------------------------
      ...
      expect(restaurant.order('agua')).toBeUndefined();
      expect(restaurant.consumption).toContain('agua');
      // objetoRetornado.order("sopa");
      expect(restaurant.order('sopa')).toBeUndefined();
      expect(restaurant.consumption).toContain('sopa');
      // objetoRetornado.order("sashimi");
      expect(restaurant.order('sashimi')).toBeUndefined();
      expect(restaurant.consumption).toContain('sashimi');
    ...
    // ```
      ...
      expect(restaurant.pay()).toBeCloseTo(12.87);
